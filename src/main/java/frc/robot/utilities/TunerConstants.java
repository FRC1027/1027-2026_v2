...
// THIS IS THE EXAMPLE CONFIGURATION FILE THAT WILL BE GENERATED BY THE CTRE APPLICATION.
// THIS IS THE EXAMPLE PROVIDED BY 
// https://v6.docs.ctr-electronics.com/en/stable/docs/api-reference/mechanisms/swerve/swerve-builder-api.html#full-example
// EVERYTHING BELOW THIS COMMENT SHOULD BE REPLACED BY THE FILE GENERATED BY CTRE.
// (OR JUST DELETE THIS WHOLE FILE IF THAT IS EASIER)
